...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvDate,
      @NonNull TextView tvLabel, @NonNull TextView tvOrganizer, @NonNull TextView tvPrice) {
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvOrganizer;
      TextView tvOrganizer = rootView.findViewById(id);
      if (tvOrganizer == null) {
        break missingId;
      }
      ...
      return new ItemEventBinding((ConstraintLayout) rootView, tvDate, tvLabel, tvOrganizer,
          tvPrice);
    }
